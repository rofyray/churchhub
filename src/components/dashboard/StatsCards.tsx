  ...
  return (
    <Card variant="stat" className="p-5">
      <div className="flex items-start justify-between">
        ...
        <div className="flex-shrink-0 p-3 bg-brand-600/20 rounded-xl">
          {icon}
        </div>
      </div>
    </Card>
...
export default function StatsCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <StatCard
        title="Year-to-Date Welfare"
        value={`GHS ${ytdWelfare.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
        icon={
          <svg className="w-6 h-6 text-brand-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
